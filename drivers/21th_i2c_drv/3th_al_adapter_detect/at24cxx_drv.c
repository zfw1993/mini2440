...
static const unsigned short address_list[] = { 0x60, 0x50, I2C_CLIENT_END }; /* 0x60只是做演示, 实际不存在这个设备 */

/* 1. 分配/设置i2c_driver结构体 */
static struct i2c_driver at24cxx_driver = {
	.class		= I2C_CLASS_HWMON,  /* 表示去哪类适配器上查找设备 */
	.driver = {
	...
	.address_list	= address_list, /* 这些设备的地址 */
};
